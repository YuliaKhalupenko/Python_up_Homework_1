...
if __name__ == '__main__':
    ...
    # python Lection_15/Homework_15/Matrix_terminal.py
    # python Lection_15/Homework_15/Matrix_terminal.py -m_1='124 252 253' -m_2='124 252 253'
    # python Lection_15/Homework_15/Matrix_terminal.py -m_1='124 252 253' -m_2='124 252 253' -operation='='
    # python Lection_15/Homework_15/Matrix_terminal.py -m_1='124 252 253' -m_2='124 252 253' -operation='*'
