...
if __name__ == '__main__':
    ...
    while True:
        ...
        try:
            a_1 = float(input('введите сторону А первого прямоугольника '))
            b_1 = float(input('введите сторону В первого прямоугольника '))
            a_2 = float(input('введите сторону А второго прямоугольника '))
            b_2 = float(input('введите сторону В второго прямоугольника '))
        ...
        choise = input("Выберите операции над прямоугольниками\n1 - сложение\n2 - вычитание\n3 - выход\n")
        match choise:
            case '1':
